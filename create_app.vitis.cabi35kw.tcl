...
set workspace     ${tcl_path}/../zynq_axs_cabi35kw

# Set platform and project names
set hw_project {"zynq_axs_cabi35kw_rev100_7z007i1"}
set xsa_file   {"./xsa/zynq_axs_cabi35kw_rev100_7z007i1.xsa"}

set app_project   "axs_cabi35kw"
...
setSymbol       ${app_project} release _HW_AXS_CABI35KW;
...
setSymbol       ${app_project} debug _HW_AXS_CABI35KW;
