...
set workspace     ${tcl_path}/../zynq_axs_dayco22kw

# Set platform and project names
set hw_project {"zynq_axs_dayco22kw_rev100_7z010i1"}
set xsa_file   {"./xsa/zynq_axs_dayco22kw_rev100_7z010i1.xsa"}

set app_project   "axs_dayco22kw"
