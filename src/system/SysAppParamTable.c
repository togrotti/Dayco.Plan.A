...
//    {0x0C36, COMMONPARAMDB_FLAG_RD, COMMONPARAMDB_TYPE_SLONG, 0, 1, WRDENY_DEFAULT, &sPo_PostnerOut.slPosErr, NULL},                    // Position error measured
    ...
    {0x0E35, COMMONPARAMDB_FLAG_RD, COMMONPARAMDB_TYPE_SWORD, 0, 1, WRDENY_DEFAULT,   &sMh_MotorDataOut.swVMotor, NULL},                  // Vmotor
    ...
    {0x0EA5, COMMONPARAMDB_FLAG_RD, COMMONPARAMDB_TYPE_SLONG, 1, 1, WRDENY_PARAMSAVE, &sDflx_Out.slDflxId, NULL},
    {0x0EA6, COMMONPARAMDB_FLAG_RD, COMMONPARAMDB_TYPE_SLONG, 1, 1, WRDENY_PARAMSAVE, &sDflx_Out.slDflxId_Matrix, NULL},

#if CFG_DFLX_VMOTOR
    {0x0EA7, COMMONPARAMDB_FLAG_RD, COMMONPARAMDB_TYPE_SLONG, 1, 1, WRDENY_PARAMSAVE, &sDflx_Out.slDflxId_VmotorPi, NULL},
#endif
    ...
    {0x0EAC, COMMONPARAMDB_FLAG_RD, COMMONPARAMDB_TYPE_UBYTE, 0, 1, WRDENY_PARAMSAVE, &sDflx_Out.flags.b.bDefluxOnly_Matrix, NULL},
    {0x0EAD, COMMONPARAMDB_FLAG_RD, COMMONPARAMDB_TYPE_UBYTE, 0, 1, WRDENY_PARAMSAVE, &sDflx_Out.flags.b.bDefluxActive_Matrix, NULL},
    {0x0EAE, COMMONPARAMDB_FLAG_RD, COMMONPARAMDB_TYPE_SLONG, 1, 1, WRDENY_PARAMSAVE, &sDflx_Out.sMatrixIqLimit.slMax, NULL},
    {0x0EAF, COMMONPARAMDB_FLAG_RD, COMMONPARAMDB_TYPE_SLONG, 1, 1, WRDENY_PARAMSAVE, &sDflx_Out.sMatrixIqLimit.slMin, NULL},

#if CFG_DFLX_VMOTOR
    {0x0EB0, COMMONPARAMDB_FLAG_RW, COMMONPARAMDB_TYPE_FLOAT, 0, 1, WRDENY_PARAMSAVE, &sDflx_Param.flPiManualRefVal, NULL},
    {0x0EB1, COMMONPARAMDB_FLAG_RW, COMMONPARAMDB_TYPE_FLOAT, 0, 1, WRDENY_PARAMSAVE, &sDflx_Param.flMargin, NULL},
    {0x0EB2, COMMONPARAMDB_FLAG_RW, COMMONPARAMDB_TYPE_FLOAT, 0, 1, WRDENY_PARAMSAVE, &sDflx_Param.flPiKi, NULL},
    {0x0EB3, COMMONPARAMDB_FLAG_RW, COMMONPARAMDB_TYPE_FLOAT, 0, 1, WRDENY_PARAMSAVE, &sDflx_Param.flPiKp, NULL},
    {0x0EB4, COMMONPARAMDB_FLAG_RW, COMMONPARAMDB_TYPE_FLOAT, 0, 1, WRDENY_PARAMSAVE, &sDflx_Param.flPiLimitMax, NULL},
    {0x0EB5, COMMONPARAMDB_FLAG_RW, COMMONPARAMDB_TYPE_FLOAT, 0, 1, WRDENY_PARAMSAVE, &sDflx_Param.flPiLimitMin, NULL},
    {0x0EB6, COMMONPARAMDB_FLAG_RW, COMMONPARAMDB_TYPE_FLOAT, 0, 1, WRDENY_PARAMSAVE, &sDflx_Param.flPiEnableSpeed, NULL},
    {0x0EB7, COMMONPARAMDB_FLAG_RW, COMMONPARAMDB_TYPE_UBYTE, 0, 1, WRDENY_PARAMSAVE, &sDflx_Param.bDefluxOnly_Matrix, NULL},
    {0x0EB8, COMMONPARAMDB_FLAG_RW, COMMONPARAMDB_TYPE_UBYTE, 0, 1, WRDENY_PARAMSAVE, &sDflx_Param.bDefluxOnly_VmotorPi, NULL},
    {0x0EB9, COMMONPARAMDB_FLAG_RD, COMMONPARAMDB_TYPE_UBYTE, 0, 1, WRDENY_PARAMSAVE, &sDflx_Out.flags.b.bDefluxOnly_VmotorPi, NULL},
    {0x0EBA, COMMONPARAMDB_FLAG_RD, COMMONPARAMDB_TYPE_UBYTE, 0, 1, WRDENY_PARAMSAVE, &sDflx_Out.flags.b.bDefluxActive_VmotorPi, NULL},
    {0x0EBB, COMMONPARAMDB_FLAG_RD, COMMONPARAMDB_TYPE_UBYTE, 0, 1, WRDENY_PARAMSAVE, &sDflx_Out.flags.b.bVmotorPiLimitActive, NULL},
    {0x0EBC, COMMONPARAMDB_FLAG_RD, COMMONPARAMDB_TYPE_FLOAT, 1, 1, WRDENY_PARAMSAVE, &sDflx_Out.flVdcBus, NULL},
    {0x0EBD, COMMONPARAMDB_FLAG_RD, COMMONPARAMDB_TYPE_FLOAT, 1, 1, WRDENY_PARAMSAVE, &sDflx_Out.flVMotorMax, NULL},
    {0x0EBE, COMMONPARAMDB_FLAG_RD, COMMONPARAMDB_TYPE_FLOAT, 1, 1, WRDENY_PARAMSAVE, &sDflx_Out.flPiRef, NULL},
    {0x0EBF, COMMONPARAMDB_FLAG_RD, COMMONPARAMDB_TYPE_FLOAT, 1, 1, WRDENY_PARAMSAVE, &sDflx_Out.flPiFbk, NULL},
    {0x0EC0, COMMONPARAMDB_FLAG_RD, COMMONPARAMDB_TYPE_FLOAT, 1, 1, WRDENY_PARAMSAVE, &sDflx_Out.flPiErr, NULL},
    {0x0EC1, COMMONPARAMDB_FLAG_RD, COMMONPARAMDB_TYPE_FLOAT, 1, 1, WRDENY_PARAMSAVE, &sDflx_Out.flPiIntegral, NULL},
    {0x0EC2, COMMONPARAMDB_FLAG_RD, COMMONPARAMDB_TYPE_FLOAT, 1, 1, WRDENY_PARAMSAVE, &sDflx_Out.flPiProportional, NULL},
    {0x0EC3, COMMONPARAMDB_FLAG_RD, COMMONPARAMDB_TYPE_FLOAT, 1, 1, WRDENY_PARAMSAVE, &sDflx_Out.flPiOut, NULL},
    {0x0EC4, COMMONPARAMDB_FLAG_RD, COMMONPARAMDB_TYPE_SLONG, 1, 1, WRDENY_PARAMSAVE, &sDflx_Out.sPiIqLimit.slMax, NULL},
    {0x0EC5, COMMONPARAMDB_FLAG_RD, COMMONPARAMDB_TYPE_SLONG, 1, 1, WRDENY_PARAMSAVE, &sDflx_Out.sPiIqLimit.slMin, NULL},
#endif
